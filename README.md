...
Microsoft SharePoint: Estruturação do portal, governança de dados e permissões de acesso.


Microsoft Teams: Implementação de fluxo de comunicação e agendamento de reuniões.


Microsoft Forms: Coleta de dados para avaliação de competências técnicas da equipe.


Análise de Dados (Excel/Insights): Processamento dos resultados da pesquisa para identificação de gaps de conhecimento.
...
Eficiência Operacional: Redução do tempo de busca por documentos e melhoria na comunicação assíncrona entre turnos.


Capacitação Técnica: Nivelamento do conhecimento da equipe sobre as ferramentas oficiais da instituição.


Legado Tecnológico: Entrega de um ecossistema funcional e documentado para a continuidade dos processos da Saúde Pública na unidade.
